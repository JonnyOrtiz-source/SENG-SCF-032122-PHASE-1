...
function addPoke(e) {
   ...
   const postUrl = 'http://localhost:3000/characters';
   fetch(postUrl, {
      method: 'POST',
      headers: {
...
function commentsForm() {
   ...
   form.addEventListener('click', console.log('BOOM!!!'));
...
function loadComments(pokeCard, character) {
   ...
   commentsList.appendChild(numComments);
